<div>
    {{-- overlay --}}
    <div @click="openCreditModal=false" class="duration-75  bg-black/30 absolute inset-0 " x-show="openCreditModal"
    ...
    {{-- main content --}}
    <div class="rounded-t-3xl translate-y-0  bg-white absolute bottom-0 inset-x-0 " x-show="openCreditModal"
        ...
        {{-- content --}}
        <div class="p-5">
            <h2 class="mb-5 text-2xl text-green-700">You are getting (Credit)</h2>
            ...
            <form class="flex flex-col gap-2" wire:submit="store">
                ...
                <div class="flex gap-5 my-4">
                    ...
                    <button @click="openCreditModal=false" type="button"
