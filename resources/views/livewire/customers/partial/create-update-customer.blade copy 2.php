<div>
    ...
    @if ($isOpen)
        <div class="absolute bottom-0 w-full  h-full  overflow-hidden bg-black/20" wire:click="closeModal()"></div>
        <div class="absolute bottom-0 w-full  bg-white rounded-t-2xl overflow-hidden pb-10">
